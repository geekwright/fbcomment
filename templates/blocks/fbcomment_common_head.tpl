    ...
    <{if !empty($block.showogmetaform)}>
        ...
        <div id="fbc_dd_dialogform">
            ...
            <div style="margin: 2em;">
                <form id="fbc_dd_upload" action="<{$block.formaction}>" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <textarea id="fbc_dd_ogdesc" name="fbc_dd_ogdesc" rows="4"
                                  cols="40"><{$block.ogdescription}></textarea> <a
                                href="javascript:getDescription('fbc_dd_ogdesc')"
                                class="fbc_dd_grabbutton"><{$smarty.const._MB_FBCOM_OGEDIT_GRAB}></a>
                    </div>
                ...
                <div class="fbc_dd_showhide"><a id="displayText"
                                                href="javascript:hideDiv('fbc_dd_dialogform');"><{$smarty.const._MB_FBCOM_OGEDIT_HIDE_EDITOR}></a>
                </div>
                <div class="fbc_dd_url"><strong>URL: </strong> <a href="<{$block.ogurl}>"
                                                                  target="_blank"><{$block.ogurl}></a> <a
                            href="http://developers.facebook.com/tools/lint?url=<{$block.ogurlenc}>"
                            target="_blank"><{$smarty.const._MB_FBCOM_OGEDIT_DEBUGGER}></a></div>
            </div>
        </div>
