...
compatabilitytest();
	...
	if($xoop25plus) {
		...
		if(empty($xoopsModuleConfig['facebook-admins']) && empty($xoopsModuleConfig['facebook-appid'])) {
			$moduleAdmin->addConfigBoxLine('<span style="color:orange"><img src="../images/admin/warn.png" alt="!" />'._AM_FBCOM_WARN_SET_ADMIN.'</span>', 'default');
		}
		...
		if(empty($xoopsModuleConfig['facebook-admins']) && empty($xoopsModuleConfig['facebook-appid'])) {
			echo '<tr><td><br /><br /><span style="color:orange; margin:2em;"><img src="../images/admin/warn.png" alt="!" />'._AM_FBCOM_WARN_SET_ADMIN.'</span></td></tr>';
		}
		if(!$xoopsModuleConfig['use-smarty-for-ogdata']) {
			echo '<tr><td><br /><br /><span style="color:orange; margin:2em;"><img src="../images/admin/warn.png" alt="!" />'._AM_FBCOM_WARN_USE_SMARTY.'</span></td></tr>';
		}
